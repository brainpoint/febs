...
function ( /* String */ str, /* Number */ crc ) {
    ...
    for( var i = 0, iTop = str.length; i < iTop; i++ ) {
      crc = (crc >>> 8) ^ febs.crypt.crc32_table[(crc ^ str.charCodeAt(i)) & 0xFF];
    }
    return crc ^ (-1);
}
